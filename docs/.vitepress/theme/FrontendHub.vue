<template>
  <div class="frontend-hub-container">
    <!-- Hub Header -->
    ...
    <div class="hub-grid">
      <!-- 1. HTML5 -->
      <a href="/frontend/html/introduction-to-html" class="hub-card">
      ...
      <!-- 2. CSS3 -->
      <a href="/frontend/css/introduction-to-css" class="hub-card">
        <div class="hub-card-header">
      ...
      <!-- 3. JavaScript -->
      <a href="/frontend/javascript/introduction-to-javascript" class="hub-card">
        <div class="hub-card-header">
          ...
          <div class="hub-card-meta">
            ...
            <span class="hub-pill pill-js">Runtime Engine</span>
          </div>
        </div>
        <p class="hub-card-desc">
      ...
      <!-- 4. React.js -->
      <a href="/frontend/react/introduction-to-react" class="hub-card">
        <div class="hub-card-header">
      ...
      <!-- 5. Next.js -->
      <a href="/frontend/nextjs/introduction-to-nextjs" class="hub-card">
        <div class="hub-card-header">
